---
title: Institutional Design After Rebellion
date: 2026-07-12
order: 12
author: Liutao Hu
...
1. The holding of wealth does not cross the phase transition threshold, that is, does not shift from a means of direct use into a variable that alters others' feasible sets.
2. Even if someone attempts to cross the threshold, the institution has sufficient anti-capture mechanisms to make success difficult.
3. Even if capture partially occurs, the institution has the capacity for self-correction.
