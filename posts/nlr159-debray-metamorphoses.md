...
这篇文章和本刊发表的《未来的暴政》有一种隐秘的共振。那篇论证"未来"如何变成了一种不合法的主权——它以未来的名义要求现在的牺牲。德布雷的文章从经验的角度印证了这一点：整个欧洲文明曾经围绕"未来"组织自己——进步、革命、光辉灿烂的明天。现在，那个未来在退潮。退潮之后的风景就是《变形记》的全部内容——膨胀的当下，空壳的符号，无处安放的死亡。
